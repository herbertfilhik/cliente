	...
	<form:form method="POST" action="/addCliente">
		<table>
			...
			<tr>
				...
				<td><form:input path="dataNascimento" formatDate pattern="dd/MM/yyyy" required="required" /></td>
			</tr>
			<tr>
				<td><form:label path="dataLancamento">Data de Lançamento: dd/mm/aaaa</form:label></td>
				<td><form:input path="dataLancamento" formatDate pattern="dd/MM/yyyy" required="required" /></td>
			</tr>
			<tr>
