	...
	<form:form method="POST" action="/addCliente">
		<table>
			...
			<tr>
				...
				<td><form:input path="dataNascimento" pattern="(([1-2][0-9])|([1-9])|(3[0-1]))/((1[0-2])|([1-9]))/[0-9]{4}" required="required" /></td>
			</tr>
			<tr>
				<td><form:label path="dataLancamento">Data de Lançamento: dd/mm/aaaa</form:label></td>
				<td><form:input path="dataLancamento" pattern="(([1-2][0-9])|([1-9])|(3[0-1]))/((1[0-2])|([1-9]))/[0-9]{4}" required="required" /></td>
			</tr>
			<tr>
