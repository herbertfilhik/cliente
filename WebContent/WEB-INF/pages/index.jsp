	...
	<form:form method="POST" action="/addCliente">
		<table>
			...
			<tr>
				...
				<td><form:input path="dataNascimento" pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/]\d{4}" required="required" /></td>
			</tr>
			<tr>
				<td><form:label path="dataLancamento">Data de Lançamento: dd/mm/aaaa</form:label></td>
				<td><form:input path="dataLancamento" pattern="(0[1-9]|[12][0-9]|3[01])[/](0[1-9]|1[012])[/]\d{4}" required="required" /></td>
			</tr>
			<tr>
